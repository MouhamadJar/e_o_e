...
class ReviewerInfo{
  ...
  ReviewerInfo({required this.reviewerImg ,required this.reviewerName ,required this.reviewerComment});
}
                ...
                FittedBox(
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                          onTap: (){},
                          child: SvgPicture.asset("assets/like (1).svg",height: size.maxHeight*.07,)),
                      SizedBox(width: size.maxWidth*.03,),
                      GestureDetector(
                          onTap: (){},
                          child: SvgPicture.asset("assets/dislike.svg",height: size.maxHeight*.07,)),
                    ],
                  ),
                ),
              ],
